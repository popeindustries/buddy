    ...
    describe('js', () => {
      ...
      it('should build a js file with es6 import', (done) => {
        buddy = buddyFactory({
          ...
          options: {
            babel: {
              plugins: [['babel-plugin-transform-es2015-modules-commonjs', { loose: true }]]
            }
          }
        });
        buddy.build((err, filepaths) => {
