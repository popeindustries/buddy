...
describe('file', function () {
	...
	describe('factory', function () {
		it('should decorate a new File instance with passed data', function () {
			var instance = fileFactory(path.resolve('src/main.js'), true, {type:'js', sources:[path.resolve('src')]});
		...
		it('should resolve a module id for an "index" File instance', function () {
			var instance = fileFactory(path.resolve('src/index.js'), true, {type:'js', sources:[path.resolve('src')]});
		...
		it('should resolve a module id for a node_module "index" File instance ', function () {
			var instance = fileFactory(path.resolve('node_modules/foo/index.js'), true, {type:'js', sources:[]});
		...
		it('should resolve a module id for a node_modules package.json "main" File instance', function () {
			var instance = fileFactory(path.resolve('node_modules/bar/bar.js'), true, {type:'js', sources:[]});
	...
	describe('workflow', function () {
		...
		describe('wrap()', function () {
			...
			it('should wrap js file contents in a lazy module definition', function (done) {
				var instance = fileFactory(path.resolve('src/main.js'), true, {type:'js', sources:[path.resolve('src')], runtimeOptions:{lazy:true}});
				instance.id = 'main';
				instance.content = "module.exports = 'main';";
				instance.wrap(function (err) {
		...
		describe('lint()', function () {
			it('should skip compileable files', function (done) {
				var instance = fileFactory(path.resolve('src/main.coffee'), true, {type:'js', sources:[path.resolve('src')]});
			...
			it('should return lint errors for badly written js content', function (done) {
				var instance = fileFactory(path.resolve('src/main-bad.js'), true, {type:'js', sources:[path.resolve('src')]});
				instance.content = fs.readFileSync(instance.filepath, 'utf8');
				var warnings = instance.lint();
			...
			it('should return lint errors for badly written css content', function (done) {
				var instance = fileFactory(path.resolve('src/main-bad.css'), true, {type:'css', sources:[path.resolve('src')]});
				instance.content = fs.readFileSync(instance.filepath, 'utf8');
				var warnings = instance.lint();
				should.exist(warnings);
				done();
		...
		describe('compress()', function () {
			...
			it('should compress css file contents', function (done) {
				var instance = fileFactory(path.resolve('src/main.css'), true, {type:'css', sources:[path.resolve('src')]});
		...
		describe('parse()', function () {
			it('should store an array of js dependencies', function (done) {
				var options = {type:'js', sources:[path.resolve('src')]}
					, foo = fileFactory(path.resolve('src/foo.js'), true, options)
					, bar = fileFactory(path.resolve('src/bar.js'), true, options)
					, instance = fileFactory(path.resolve('src/main.js'), true, options);
			...
			it('should store an array of css dependency objects', function (done) {
				var options = {type:'css', sources:[path.resolve('src')]}
					, foo = fileFactory(path.resolve('src/foo.css'), true, options)
					, instance = fileFactory(path.resolve('src/main.css'), true, options);
			...
			it('should store an array of html dependency objects', function (done) {
				var options = {type:'html', sources:[path.resolve('src')], fileExtensions:['html', 'dust']}
					, foo = fileFactory(path.resolve('src/foo.dust'), true, options)
					, instance = fileFactory(path.resolve('src/main.dust'), true, options);
		...
		describe('replaceReferences()', function () {
			...
			it('should replace relative html include paths with absolute ones', function (done) {
				var instance = fileFactory(path.resolve('src/main.dust'), true, {type:'html', sources:[path.resolve('src')]});
				instance.content = "{>foo /}";
				instance.dependencyReferences = [
					{
						filepath:'foo',
		...
		describe('run()', function () {
			...
			it('should return several files when parsing dependencies', function (done) {
				var instance = fileFactory(path.resolve('src/bar.js'), true, {type:'js', sources:[path.resolve('src')]});
