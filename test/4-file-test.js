...
describe('file', () => {
  ...
  describe('JSFile', () => {
    ...
    describe('constructor()', () => {
      ...
      it('should fix Browserify boilerplate', () => {
        ...
        expect(file.content).to.contain(
          "if(typeof $m['src/browserify1'].exports===\"object\"&&typeof $m['src/browserify1']!==\"undefined\"){$m['src/browserify1'].exports=f()"
        );
      });
      it('should fix Webpack boilerplate', () => {
        file = create('src/webpack.js');
        expect(file.content).to.contain(
          "if(typeof $m['src/webpack'].exports === 'object' && typeof $m['src/webpack'] === 'object')\n    $m['src/webpack'].exports = factory();"
        );
      });
      it('should fix Closure boilerplate', () => {
        file = create('src/closure.js');
        expect(file.content).to.contain(
          "if (typeof $m['src/closure'].exports === \"object\") {\n    $m['src/closure'].exports = factory.call(root);"
        );
      });
      it('should fix UMD boilerplate', () => {
        file = create('src/umd.js');
        expect(file.content).to.contain(
          "typeof $m['src/umd'].exports === 'object' && typeof $m['src/umd'] !== 'undefined' ? $m['src/umd'].exports = factory()"
        );
      });
      it('should fix D3 boilerplate', () => {
        file = create('src/d3.js');
        expect(file.content).to.contain(
          "typeof $m['src/d3'].exports === 'object' && typeof $m['src/d3'] !== 'undefined' ? factory($m['src/d3'].exports)"
        );
      });
    });
    ...
    describe('hashContent()', () => {
      it('should hash content for write', () => {
        file.content = 'require("bar");';
        expect(file.hashContent(true)).to.equal('e80da0acd7696ec89f1bf93746a0c8d1');
      });
      it('should hash content for write, including dependencies', () => {
        file.content = 'require("bar");';
        file.dependencyReferences = [
          {
            file: {
              content: fs.readFileSync(path.resolve('./node_modules/bar/bar.js'), 'utf8'),
              dependencies: [],
              dependencyReferences: [],
        ...
        expect(file.hashContent(true)).to.equal('986c26be896467f93df975bf0825196d');
      });
      it('should hash content for write, including dynamic dependencies', () => {
        file.content = 'require("bar");';
        file.dependencyReferences = [
          {
            file: {
        ...
        file.dynamicDependencyReferences = [
          {
            file: {
              writeHash: '986c26be896467f93df975bf0825196d'
            }
          }
        ];
        expect(file.hashContent(true)).to.equal('9761209f01bafc4166ac48ba954fcfd2');
      });
      it('should hash content for write, including dynamic dependencies of dependencies', () => {
        file.content = 'require("bar");';
        file.dependencyReferences = [
          {
            file: {
        ...
        expect(file.hashContent(true)).to.equal('a1d3e4a86bd59c5d839a998eee6b65e5');
      });
    });
