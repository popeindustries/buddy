    ...
    describe('js', () => {
      ...
      it('should build a js file with unique hashed name', (done) => {
        builder.build({
          ...
          expect(fs.existsSync(filepaths[0])).to.be(true);
          expect(path.basename(filepaths[0])).to.eql('foo-6e5cf49b7e62fa876b9f7f315bfc0f53.js');
          done();
        });
      });
      it('should build a minified js file if "compress" is true', (done) => {
        builder.build({
          ...
          expect(content).to.equal('null==window._m_&&(window._m_={}),null==window.require&&(window.require=function(o){return null==_m_[o].exports?_m_[o]():_m_[o]}),_m_["foo.js"]=function(o,r){o=this,r=o.exports;return o.exports}.call({exports:{}}),_m_["bar.js"]=function(o,r){o=this,r=o.exports;_m_["foo.js"];return o.exports}.call({exports:{}});');
          done();
        });
      });
