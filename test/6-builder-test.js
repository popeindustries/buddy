    ...
    describe('js', () => {
      ...
      it('should build a js file with unique hashed name', (done) => {
        builder.build({
          ...
          expect(fs.existsSync(filepaths[0])).to.be(true);
          expect(path.basename(filepaths[0])).to.eql('foo-2f24ec6412a4a29821d843c0b7c6059f.js');
          done();
        });
      });
      it('should build a minified js file if "compress" is true', (done) => {
        builder.build({
          ...
          expect(content).to.equal('if("undefined"==typeof self)var self=this;if("undefined"==typeof global)var global=self;null==self._m_&&(self._m_={}),null==self.require&&(self.require=function(e){if(_m_[e])return _m_[e].boot?_m_[e]():_m_[e]}),_m_["foo.js"]=function(e,f){e=this,f=e.exports;return e.exports}.call({exports:{}}),_m_["bar.js"]=function(e,f){e=this,f=e.exports;_m_["foo.js"];return e.exports}.call({exports:{}});');
          done();
        });
      });
      ...
      it('should remove dead code when referencing "process.env.RUNTIME" and compressing', (done) => {
        builder.build({
          ...
          expect(content).to.contain('var l=!1;return console.log("is dev: ",l)');
          done();
        });
      });
