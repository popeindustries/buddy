    ...
    describe('js', () => {
      ...
      it('should build a js file with unique hashed name', (done) => {
        builder.build({
          ...
          expect(fs.existsSync(filepaths[0])).to.be(true);
          expect(path.basename(filepaths[0])).to.eql('foo-aa9a8621c095218926c7f3f4ad5abb64.js');
          done();
        });
      });
      it('should build a minified js file if "compress" is true', (done) => {
        builder.build({
          ...
          expect(content).to.equal('null==window._m_&&(window._m_={}),null==window.require&&(window.require=function(o){return _m_[o]?_m_[o].boot?_m_[o]():_m_[o]:void 0}),_m_["foo.js"]=function(o,_){o=this,_=o.exports;return o.exports}.call({exports:{}}),_m_["bar.js"]=function(o,_){o=this,_=o.exports;_m_["foo.js"];return o.exports}.call({exports:{}});');
          done();
        });
      });
      ...
      it('should remove dead code when referencing "process.env.RUNTIME" and compressing', (done) => {
        builder.build({
          ...
          expect(content).to.contain('var e=!1;return console.log("is dev: ",e)');
          done();
        });
      });
    });
