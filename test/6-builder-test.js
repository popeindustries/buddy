    ...
    describe('js', () => {
      ...
      it('should build a js file with unique hashed name', (done) => {
        builder.build({
          ...
          expect(fs.existsSync(filepaths[0])).to.be(true);
          expect(path.basename(filepaths[0])).to.eql('foo-3f3e804f7b0638a0119de85352d3abf6.js');
          done();
        });
      });
      it('should build a minified js file if "compress" is true', (done) => {
        builder.build({
          ...
          expect(content).to.equal('null==window.$m&&(window.$m={}),null==window.require&&(window.require=function(o){return null==$m[o].exports?$m[o]():$m[o]}),$m["foo.js"]=function(o,r){o=this,r=o.exports;return o.exports}.call({exports:{}}),$m["bar.js"]=function(o,r){o=this,r=o.exports;$m["foo.js"];return o.exports}.call({exports:{}});');
          done();
        });
      });
      ...
      it('should remove dead code when referencing "process.env.RUNTIME" and compressing', (done) => {
        builder.build({
          ...
          expect(content).to.contain('var r=!1;return console.log("is dev: ",r)');
          done();
        });
      });
    });
