    ...
    describe('js', () => {
      ...
      it('should build a js file with unique hashed name', (done) => {
        builder.build({
          ...
          expect(fs.existsSync(filepaths[0])).to.be(true);
          expect(path.basename(filepaths[0])).to.eql('foo-b2d586af99361d0c7fced65980bda6a7.js');
          done();
        });
      });
      it('should build a minified js file if "compress" is true', (done) => {
        builder.build({
          ...
          expect(content).to.equal('null==window._m_&&(window._m_={}),null==window.require&&(window.require=function(o){return _m_[o]?null==_m_[o].exports?_m_[o]():_m_[o]:void 0}),_m_["foo.js"]=function(o,r){o=this,r=o.exports;return o.exports}.call({exports:{}}),_m_["bar.js"]=function(o,r){o=this,r=o.exports;_m_["foo.js"];return o.exports}.call({exports:{}});');
          done();
        });
      });
