...
* *compile* command renamed to *build*
...
* *require* boilerplate no longer included in generated source; install *git://github.com/popeindustries/browser-require.git* or equivalent
