...
$m['coffee-script/lib/coffee-script/helpers.js#1.11.0'] = { exports: {} };
// Generated by CoffeeScript 1.11.0
(function () {
  var buildLocationData, extend, flatten, ref, repeat, syntaxErrorToString;

  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.starts = function (string, literal, start) {
    return literal === string.substr(start, literal.length);
  };

  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.ends = function (string, literal, back) {
    var len;
    len = literal.length;
    return literal === string.substr(string.length - len - (back || 0), len);
  };

  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.repeat = repeat = function (str, n) {
    var res;
    res = '';
    while (n > 0) {
      if (n & 1) {
  ...
  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.compact = function (array) {
  ...
  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.count = function (string, substr) {
    var num, pos;
    num = pos = 0;
    if (!substr.length) {
      return 1 / 0;
  ...
  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.merge = function (options, overrides) {
    return extend(extend({}, options), overrides);
  };

  extend = $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.extend = function (object, properties) {
    var key, val;
  ...
  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.flatten = flatten = function (array) {
  ...
  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.del = function (obj, key) {
    var val;
    val = obj[key];
    delete obj[key];
    return val;
  ...
  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.some = (ref = Array.prototype.some) != null ? ref : function (fn) {
    var e, i, len1, ref1;
    ref1 = this;
  ...
  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.invertLiterate = function (code) {
  ...
  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.addLocationDataFn = function (first, last) {
    return function (obj) {
  ...
  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.locationDataToString = function (obj) {
    var locationData;
  ...
  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.baseFileName = function (file, stripExt, useWinPathSep) {
    var parts, pathSep;
    if (stripExt == null) {
      stripExt = false;
    }
  ...
  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.isCoffee = function (file) {
    return (/\.((lit)?coffee|coffee\.md)$/.test(file)
    );
  };

  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.isLiterate = function (file) {
    return (/\.(litcoffee|coffee\.md)$/.test(file)
    );
  };

  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.throwSyntaxError = function (message, location) {
    var error;
  ...
  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.updateSyntaxError = function (error, code, filename) {
  ...
  $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports.nameWhitespaceCharacter = function (string) {
    switch (string) {
      case ' ':
        return 'space';
      case '\n':
...
$m['coffee-script/lib/coffee-script/rewriter.js#1.11.0'] = { exports: {} };
// Generated by CoffeeScript 1.11.0
(function () {
  var BALANCED_PAIRS,
      CALL_CLOSERS,
  ...
  $m['coffee-script/lib/coffee-script/rewriter.js#1.11.0'].exports.Rewriter = function () {
    function Rewriter() {}
  ...
  $m['coffee-script/lib/coffee-script/rewriter.js#1.11.0'].exports.INVERSES = INVERSES = {};
...
$m['coffee-script/lib/coffee-script/lexer.js#1.11.0'] = { exports: {} };
// Generated by CoffeeScript 1.11.0
(function () {
  var BOM,
      BOOL,
  ...
  ref = $m['coffee-script/lib/coffee-script/rewriter.js#1.11.0'].exports, Rewriter = ref.Rewriter, INVERSES = ref.INVERSES;

  ref1 = $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports, count = ref1.count, starts = ref1.starts, compact = ref1.compact, repeat = ref1.repeat, invertLiterate = ref1.invertLiterate, locationDataToString = ref1.locationDataToString, throwSyntaxError = ref1.throwSyntaxError;

  $m['coffee-script/lib/coffee-script/lexer.js#1.11.0'].exports.Lexer = Lexer = function () {
    function Lexer() {}
  ...
  $m['coffee-script/lib/coffee-script/lexer.js#1.11.0'].exports.isUnassignable = isUnassignable;
  ...
  $m['coffee-script/lib/coffee-script/lexer.js#1.11.0'].exports.JS_FORBIDDEN = JS_KEYWORDS.concat(RESERVED).concat(STRICT_PROSCRIBED);
...
$m['coffee-script/lib/coffee-script/scope.js#1.11.0'] = { exports: {} };
// Generated by CoffeeScript 1.11.0
(function () {
  var Scope,
      indexOf = [].indexOf || function (item) {
  ...
  $m['coffee-script/lib/coffee-script/scope.js#1.11.0'].exports.Scope = Scope = function () {
...
$m['coffee-script/lib/coffee-script/sourcemap.js#1.11.0'] = { exports: {} };
// Generated by CoffeeScript 1.11.0
(function () {
  ...
  $m['coffee-script/lib/coffee-script/sourcemap.js#1.11.0'].exports = SourceMap;
}).call(this);
/*≠≠ node_modules/coffee-script/lib/coffee-script/sourcemap.js ≠≠*/

/*== node_modules/coffee-script/lib/coffee-script/parser.js ==*/
$m['coffee-script/lib/coffee-script/parser.js#1.11.0'] = { exports: {} };
...
*/
var _coffeescriptlibcoffeescriptparserjs1110_parser = function () {
    var o = function (k, v, o, l) {
        ...
        $VR = [1, 95],
        $VS = [1, 99],
        $VT = [1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140, 155, 158, 159, 162, 163, 164, 165, 166, 167, 168],
        $VU = [1, 105],
        $VV = [1, 106],
        $VW = [1, 107],
        $VX = [1, 108],
        ...
        $V_ = [1, 104],
        $V$ = [2, 161],
        $V01 = [1, 6, 32, 42, 131, 133, 135, 139, 155],
        $V11 = [2, 27],
        $V21 = [1, 118],
        $V31 = [1, 116],
        $V41 = [1, 6, 31, 32, 42, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 113, 114, 115, 120, 122, 131, 133, 134, 135, 139, 140, 155, 158, 159, 162, 163, 164, 165, 166, 167, 168],
        $V51 = [2, 94],
        $V61 = [1, 6, 31, 32, 42, 46, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 113, 114, 115, 120, 122, 131, 133, 134, 135, 139, 140, 155, 158, 159, 162, 163, 164, 165, 166, 167, 168],
        $V71 = [2, 73],
        $V81 = [1, 123],
        $V91 = [1, 128],
        $Va1 = [1, 129],
        $Vb1 = [1, 131],
        $Vc1 = [1, 6, 31, 32, 42, 55, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 113, 114, 115, 120, 122, 131, 133, 134, 135, 139, 140, 155, 158, 159, 162, 163, 164, 165, 166, 167, 168],
        $Vd1 = [2, 91],
        $Ve1 = [1, 6, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140, 155, 158, 159, 162, 163, 164, 165, 166, 167, 168],
        $Vf1 = [2, 63],
        $Vg1 = [1, 161],
        $Vh1 = [1, 173],
        $Vi1 = [1, 175],
        ...
        $Vk1 = [1, 177],
        $Vl1 = [1, 179],
        $Vm1 = [1, 6, 31, 32, 42, 55, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 96, 113, 114, 115, 120, 122, 131, 133, 134, 135, 139, 140, 155, 158, 159, 160, 161, 162, 163, 164, 165, 166, 167, 168, 169],
        $Vn1 = [2, 110],
        $Vo1 = [1, 6, 31, 32, 42, 58, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 113, 114, 115, 120, 122, 131, 133, 134, 135, 139, 140, 155, 158, 159, 162, 163, 164, 165, 166, 167, 168],
        $Vp1 = [1, 229],
        $Vq1 = [1, 228],
        $Vr1 = [1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140, 155],
        $Vs1 = [2, 71],
        $Vt1 = [1, 238],
        $Vu1 = [6, 31, 32, 65, 70],
        $Vv1 = [6, 31, 32, 55, 65, 70, 73],
        $Vw1 = [1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140, 155, 158, 159, 163, 165, 166, 167, 168],
        $Vx1 = [82, 83, 84, 85, 87, 90, 113, 114],
        $Vy1 = [1, 257],
        $Vz1 = [2, 62],
        $VA1 = [1, 267],
        $VB1 = [1, 273],
        $VC1 = [2, 182],
        $VD1 = [1, 6, 31, 32, 42, 55, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 113, 114, 115, 120, 122, 131, 133, 134, 135, 139, 140, 146, 147, 155, 158, 159, 162, 163, 164, 165, 166, 167, 168],
        $VE1 = [1, 283],
        $VF1 = [6, 31, 32, 70, 115, 120],
        $VG1 = [1, 6, 31, 32, 42, 55, 58, 65, 70, 73, 82, 83, 84, 85, 87, 89, 90, 94, 96, 113, 114, 115, 120, 122, 131, 133, 134, 135, 139, 140, 146, 147, 155, 158, 159, 160, 161, 162, 163, 164, 165, 166, 167, 168, 169],
        $VH1 = [1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 140, 155],
        $VI1 = [1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 134, 140, 155],
        $VJ1 = [146, 147],
        $VK1 = [70, 146, 147],
        $VL1 = [6, 31, 94],
        $VM1 = [1, 296],
        $VN1 = [6, 31, 32, 70, 94],
        $VO1 = [6, 31, 32, 58, 70, 94],
        $VP1 = [6, 31, 32, 55, 58, 70, 94],
        $VQ1 = [1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140, 155, 158, 159, 165, 166, 167, 168],
        $VR1 = [12, 28, 34, 38, 40, 41, 44, 45, 48, 49, 50, 51, 52, 53, 61, 62, 63, 67, 68, 89, 92, 95, 97, 104, 112, 117, 118, 119, 125, 129, 130, 133, 135, 137, 139, 148, 154, 156, 157, 158, 159, 160, 161],
        $VS1 = [2, 171],
        $VT1 = [6, 31, 32],
        $VU1 = [2, 72],
        $VV1 = [1, 308],
        $VW1 = [1, 309],
        $VX1 = [1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 127, 128, 131, 133, 134, 135, 139, 140, 150, 152, 155, 158, 159, 162, 163, 164, 165, 166, 167, 168],
        $VY1 = [32, 150, 152],
        $VZ1 = [1, 6, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 134, 140, 155],
        $V_1 = [1, 335],
        $V$1 = [1, 340],
        $V02 = [1, 6, 32, 42, 131, 155],
        $V12 = [2, 86],
        $V22 = [1, 350],
        $V32 = [1, 351],
        $V42 = [1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 134, 135, 139, 140, 150, 155, 158, 159, 162, 163, 164, 165, 166, 167, 168],
        $V52 = [1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 131, 133, 135, 139, 140, 155],
        $V62 = [1, 363],
        $V72 = [1, 364],
        $V82 = [6, 31, 32, 94],
        $V92 = [6, 31, 32, 70],
        $Va2 = [1, 6, 31, 32, 42, 65, 70, 73, 89, 94, 115, 120, 122, 127, 131, 133, 134, 135, 139, 140, 155, 158, 159, 162, 163, 164, 165, 166, 167, 168],
        $Vb2 = [31, 70],
        $Vc2 = [1, 390],
        $Vd2 = [1, 391],
        $Ve2 = [1, 396],
...
if (typeof require !== 'undefined' && typeof $m['coffee-script/lib/coffee-script/parser.js#1.11.0'].exports !== 'undefined') {
    $m['coffee-script/lib/coffee-script/parser.js#1.11.0'].exports.parser = _coffeescriptlibcoffeescriptparserjs1110_parser;
    $m['coffee-script/lib/coffee-script/parser.js#1.11.0'].exports.Parser = _coffeescriptlibcoffeescriptparserjs1110_parser.Parser;
    $m['coffee-script/lib/coffee-script/parser.js#1.11.0'].exports.parse = function () {
        return _coffeescriptlibcoffeescriptparserjs1110_parser.parse.apply(_coffeescriptlibcoffeescriptparserjs1110_parser, arguments);
    };
    $m['coffee-script/lib/coffee-script/parser.js#1.11.0'].exports.main = function commonjsMain(args) {
        if (!args[1]) {
            console.log('Usage: ' + args[0] + ' FILE');
            process.exit(1);
        }
        var source = require('fs').readFileSync(require('path').normalize(args[1]), "utf8");
        return $m['coffee-script/lib/coffee-script/parser.js#1.11.0'].exports.parser.parse(source);
    };
    if (typeof $m['coffee-script/lib/coffee-script/parser.js#1.11.0'] !== 'undefined' && require.main === $m['coffee-script/lib/coffee-script/parser.js#1.11.0']) {
        $m['coffee-script/lib/coffee-script/parser.js#1.11.0'].exports.main(process.argv.slice(1));
    }
}
/*≠≠ node_modules/coffee-script/lib/coffee-script/parser.js ≠≠*/

/*== node_modules/coffee-script/lib/coffee-script/coffee-script.js ==*/
$m['coffee-script/lib/coffee-script/coffee-script.js#1.11.0'] = { exports: {} };
// Generated by CoffeeScript 1.11.0
(function () {
  var Lexer,
      SourceMap,
  ...
  Lexer = $m['coffee-script/lib/coffee-script/lexer.js#1.11.0'].exports.Lexer;

  parser = $m['coffee-script/lib/coffee-script/parser.js#1.11.0'].exports.parser;

  helpers = $m['coffee-script/lib/coffee-script/helpers.js#1.11.0'].exports;

  SourceMap = $m['coffee-script/lib/coffee-script/sourcemap.js#1.11.0'].exports;

  $m['coffee-script/lib/coffee-script/coffee-script.js#1.11.0'].exports.VERSION = '1.11.0';

  $m['coffee-script/lib/coffee-script/coffee-script.js#1.11.0'].exports.FILE_EXTENSIONS = ['.coffee', '.litcoffee', '.coffee.md'];

  $m['coffee-script/lib/coffee-script/coffee-script.js#1.11.0'].exports.helpers = helpers;
  ...
  $m['coffee-script/lib/coffee-script/coffee-script.js#1.11.0'].exports.compile = compile = withPrettyErrors(function (code, options) {
  ...
  $m['coffee-script/lib/coffee-script/coffee-script.js#1.11.0'].exports.tokens = withPrettyErrors(function (code, options) {
    return lexer.tokenize(code, options);
  });

  $m['coffee-script/lib/coffee-script/coffee-script.js#1.11.0'].exports.nodes = withPrettyErrors(function (source, options) {
  ...
  $m['coffee-script/lib/coffee-script/coffee-script.js#1.11.0'].exports.run = function (code, options) {
  ...
  $m['coffee-script/lib/coffee-script/coffee-script.js#1.11.0'].exports["eval"] = function (code, options) {
  ...
  $m['coffee-script/lib/coffee-script/coffee-script.js#1.11.0'].exports.register = function () {
    return require('coffee-script/lib/coffee-script/register.js#1.11.0');
  };
  ...
  $m['coffee-script/lib/coffee-script/coffee-script.js#1.11.0'].exports._compileFile = function (filename, sourceMap, inlineMap) {
  ...
  parser.yy = $m['coffee-script/lib/coffee-script/nodes.js#1.11.0'].exports;
  ...
  getSourceMap = function (filename) {
    ...
    ref1 = $m['coffee-script/lib/coffee-script/coffee-script.js#1.11.0'].exports.FILE_EXTENSIONS;
    for (j = 0, len1 = ref1.length; j < len1; j++) {
      ext = ref1[j];
      if (helpers.ends(filename, ext)) {
        answer = $m['coffee-script/lib/coffee-script/coffee-script.js#1.11.0'].exports._compileFile(filename, true);
  ...
  Error.prepareStackTrace = function (err, stack) {
    ...
    frames = function () {
      ...
      for (j = 0, len1 = stack.length; j < len1; j++) {
        frame = stack[j];
        if (frame.getFunction() === $m['coffee-script/lib/coffee-script/coffee-script.js#1.11.0'].exports.run) {
          break;
        }
...
const _srcindexjs_coffee = $m['coffee-script/lib/coffee-script/coffee-script.js#1.11.0'].exports;

const _srcindexjs_DEFAULT_OPTIONS = {
  // Compile without function wrapper
  bare: true
};
const _srcindexjs_FILE_EXTENSIONS = ['coffee'];
const _srcindexjs_WORKFLOW_STANDARD = ['!watchOnly:compile'];
...
function _srcindexjs_define(File, utils) {
  ...
  return class COFFEESCRIPTFile extends File {
    ...
    constructor(id, filepath, options) {
      ...
      this.workflows.standard[1] = _srcindexjs_WORKFLOW_STANDARD.concat(this.workflows.standard[1]);
    }
    ...
    compile(buildOptions, fn) {
      try {
        const options = Object.assign({}, _srcindexjs_DEFAULT_OPTIONS, this.options.pluginOptions.coffeescript);
        const content = _srcindexjs_coffee.compile(this.content, options);
