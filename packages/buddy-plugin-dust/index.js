...
$m['dustjs-linkedin/lib/dust.js#2.7.4'] = { exports: {} };
(function (root, factory) {
  if (typeof define === 'function' && define.amd && define.amd.dust === true) {
    define('dust.core', [], factory);
  } else if (typeof $m['dustjs-linkedin/lib/dust.js#2.7.4'].exports === 'object') {
    $m['dustjs-linkedin/lib/dust.js#2.7.4'].exports = factory();
  } else {
    root.dust = factory();
  }
})(this, function () {
...
$m['dustjs-helpers/lib/dust-helpers.js#1.7.3'] = { exports: {} };
(function (root, factory) {
  if (typeof define === 'function' && define.amd && define.amd.dust === true) {
    define(['dust.core'], factory);
  } else if (typeof $m['dustjs-helpers/lib/dust-helpers.js#1.7.3'].exports === 'object') {
    $m['dustjs-helpers/lib/dust-helpers.js#1.7.3'].exports = factory($m['dustjs-linkedin/lib/dust.js#2.7.4'].exports);
  } else {
    factory(root.dust);
  }
})(this, function (dust) {
...
const _srcindexjs_dust = $m['dustjs-linkedin/lib/dust.js#2.7.4'].exports;

const _srcindexjs_FILE_EXTENSIONS = ['dust'];
const _srcindexjs_RE_INCLUDE = /{>\s?['"]?([^'"\s]+)['"]?\s?\/}/g;
const _srcindexjs_WORKFLOW_WRITEABLE = ['inline', 'compile', 'parseInline', 'inlineInline'];
...
module.exports = {
   ...
   */
  register(config) {
    config.registerFileDefinitionAndExtensionsForType(_srcindexjs_define, _srcindexjs_FILE_EXTENSIONS, this.type);
  }
};
 ...
 * @returns {Class}
 */
function _srcindexjs_define(File, utils) {
  ...
  return class DUSTFile extends File {
    ...
    constructor(id, filepath, options) {
      ...
      this.workflows.writeable = [_srcindexjs_WORKFLOW_WRITEABLE];
    }
    ...
    parse(buildOptions, fn) {
      ...
      // Parse includes
      let matches = uniqueMatch(this.content, _srcindexjs_RE_INCLUDE).map(match => {
    ...
    compile(buildOptions, fn) {
      // Keep whitespace
      console.log(_srcindexjs_dust);
      _srcindexjs_dust.optimizers.format = (ctx, node) => node;
      // Precompile and load
      const source = _srcindexjs_dust.compile(this.content, this.filepath);

      _srcindexjs_dust.loadSource(source);
      _srcindexjs_dust.render(this.filepath, this.findSidecarDependency(), (err, content) => {
