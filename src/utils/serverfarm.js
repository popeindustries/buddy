...
module.exports = {
   ...
   * Start the servers
   */
  start(serve: boolean, reload: boolean, options: Options, fn: (Error | null) => void) {
 ...
 * Start app server
 */
function startAppServer(fn: (Error | null) => void) {
 ...
 */
function waitForPortOpen(port: number, fn: (Error | null) => void) {
  function check() {
    if (checkingAppServerPort) {
