...
var Builder, CSS, CSSFile, CSSTarget, Configuration, Depedencies, Filelog, HTML, JS, JSFile, JSTarget, RE_IGNORE_FILE, RE_WATCH_IGNORE_FILE, Watcher, existsSync, fs, notify, path, plugins, readdir, reloader, rimraf, _ref,
...
module.exports = Builder = (function() {
  ...
  Builder.prototype.watch = function(compress, reload) {
    var _this = this;
  ...
  Builder.prototype._onWatchChange = function(filename, stats) {
    ...
    return this[type + 'Targets'].forEach(function(target) {
      ...
      return _this._runTarget(target, _this.compress, _this.lint, function(files) {
        return _this.reloading && files && reloader.refresh(files);
      });
    });
  };
