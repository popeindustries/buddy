...
module.exports = Builder = (function() {
  ...
  Builder.prototype.initialize = function(configpath) {
    var item, source, t, type, _i, _j, _k, _len, _len2, _len3, _ref, _ref2, _ref3;
    if (!this.initialized) {
  ...
  Builder.prototype.compile = function(compress, targets) {
    var t, type, _i, _len, _results;
    if (targets == null) targets = [this.JS, this.CSS];
    _results = [];
  ...
  Builder.prototype._targetFactory = function(type, options) {
    ...
    return new target[type.toUpperCase() + 'Target'](inputpath, outputpath, this[type + 'Sources'], options.nodejs);
  };
