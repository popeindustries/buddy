...
module.exports = Dependencies = (function() {
  ...
  Dependencies.prototype.clean = function() {
  ...
  Dependencies.prototype._moveSource = function(dependency) {
    ...
    if (dependency.local) {
      ...
      this.files.push(path.resolve(dependency.destination, path.basename(dependency.source)));
    } else {
      ...
      this.files.push(path.resolve(dependency.destination, path.basename(filepath)));
    }
