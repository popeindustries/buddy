...
var Source, Watcher, colour, debug, existsSync, file, ignored, indir, notify, object, path, print, readdir, reloader, strong, _ref, _ref1;
...
module.exports = Source = (function() {
  ...
  Source.prototype.add = function(filepath) {
    ...
    if (!this.byPath[filepath] && basepath) {
      return file(this.type, filepath, basepath, object.clone(this.options), function(err, instance) {
        if (err) {
          return;
        }
        _this.length++;
