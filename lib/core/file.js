...
File.prototype.load = function *() {
	if (!this.originalContent) {
		var content = yield readFile(this.filepath, 'utf8');
...
File.prototype.compile = function () {
	...
	if (!this.compiledContent && this.getIsWriteable()) {
		...
		this.content = commands['compile'](this.filepath, this.content, options);
...
File.prototype.inline = function () {
	this.content = commands['inline'](this.filepath, this.type, this.content, this.dependencyReferences);
...
File.prototype.replace = function () {
	this.content = commands['replace'](this.content, this.dependencyReferences);
...
File.prototype.lint = function () {
	...
	if (this.extension == this.type) {
		var warnings = commands['lint'](this.type, this.content)
		if (warnings) {
...
File.prototype.escape = function () {
	this.content = commands['escape'](this.content);
...
File.prototype.compress = function () {
	...
	if (compressible) {
		this.content = commands['compress'](this.type, this.content);
		print(""
...
File.prototype.wrap = function () {
	...
	this.content = commands['wrap'](this.id, this.content, lazy);
...
File.prototype.concat = function () {
	...
	if (this.getIsWriteable()) {
		this.content = commands['concat'](this.type, this.content, this.getDependencies(true));
...
File.prototype.write = function *(filepath, options) {
	if (this.getIsWriteable()) {
		...
		// Write
		yield write(filepath, this.content);
