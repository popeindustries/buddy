...
exports.parse = function (data) {
	...
	var _parseTargets = function (type, sources, targets) {
		...
		targets.forEach(function (target) {
			...
			if (!target.modular && exports.data.server && exports.data.server.file) {
				var server = path.resolve(exports.data.server.file);
				target.isAppServer = target.isDir
					? indir(target.inputPath, server)
