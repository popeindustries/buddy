...
const DYNAMIC_IMPORT_NODE_BOILERPLATE = fs.readFileSync(path.join(__dirname, './dynamic-import-node.js'), 'utf8');
const REQUIRE_BOILERPLATE = fs.readFileSync(path.join(__dirname, './require.js'), 'utf8');
const REQUIRE_NODE_BOILERPLATE = fs.readFileSync(path.join(__dirname, './require-node.js'), 'utf8');
