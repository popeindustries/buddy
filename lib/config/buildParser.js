...
function parseBuild (builds, fileExtensions, fileFactory, npmModulepaths, runtimeOptions, serverConfig, parent, level) {
  ...
  return builds.reduce((builds, buildConfig) => {
    ...
    build.fileCache = parent ? parent.fileCache : cache.createFileCache(runtimeOptions.watch);
...
function getFileFactory (build, parent, version, options, fileFactoryOptions) {
  ...
  if (needsPlugins) {
    fileFactoryOptions.pluginOptions = loadBuildPlugins(build.type, options, version);
  }
