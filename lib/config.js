...
module.exports = {
   ...
   * @param {Object} build
   * @param {Object} config
   * @param {Object} [parentBuildOptions]
   * @returns {Array}
   */
  parseBuild (build, config, parentBuildOptions) {
    if (!parentBuildOptions) numBuildTargets = 0;
    ...
    return build.reduce((build, buildTarget) => {
      ...
      buildTarget.hasParent = !!parentBuildOptions;
      ...
      if (!buildTarget.hasParent) {
        ...
        buildTarget.options = parentBuildOptions;
      }
      ...
      if (!('input' in buildTarget) || buildTarget.input != null) {
        ...
        if (buildTarget.build) {
          ...
          buildTarget.build = this.parseBuild(buildTarget.build, config, buildTarget.options);
