...
class Build {
  ...
  run (fn) {
    ...
    if (!this.watchOnly || this.watchOnly && this.runtimeOptions.watch) {
      ...
      print((this.watchOnly && this.runtimeOptions.watch ? 'watching ' : 'building ')
      ...
      (done) => {
        done(null, this.parseFiles(this.inputpaths));
      },
